  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(url, {
        ...
        body: JSON.stringify({ ...formData, category: 'promotion' }),
      });
      ...
      <div className="edit-header" style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '32px' }}>
        ...
        <div>
          <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#091D33', margin: '0 0 4px' }}>
            {isNew ? 'Новая акция' : 'Редактирование'}
          </h1>
          <p style={{ color: '#6B7280', margin: 0, fontSize: '14px' }}>
            {isNew ? 'Создание новой акции' : formData.title}
          </p>
        </div>
      </div>
                  ...
                  {tabs.map((tab) => (
                    <button
                      ...
                      style={{
                        ...
                        background: 'none',
                        cursor: 'pointer',
                        borderBottom: activeTab === tab.key ? '2px solid #EC910C' : '2px solid transparent',
                        color: activeTab === tab.key ? '#EC910C' : '#6B7280',
                        marginBottom: '-1px',
                      }}
                    >
                      {tab.label}
              ...
              <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="Полное описание акции с условиями"
                        rows={8}
                      />
                    </div>
                  </>
                ...
                {activeTab === 'kz' && (
                  <>
                    ...
                    <div>
                      <label style={labelStyle}>Полное описание (KZ)</label>
                      <textarea
